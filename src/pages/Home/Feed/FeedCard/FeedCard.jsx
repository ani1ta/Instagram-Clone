    ...
    <div>
      {instagramFeed.map((feed) => (
        <div key={feed.id} className="w-full h-auto mb-6">
          ...
          {/* Feed Img */}
          <div className="w-full lg:max-h-[75vh] md:max-h-[70vh] 
          sm:max-h-[65vh] max-h-[50vh] lg:h-[70vh] md:h-[60vh] sm:h-[50vh] 
          h-[50vh] lg:min-h-[65vh] md:min-h-[55vh] sm:min-h-[50vh] 
          min-h-[45vh] border border-gray-300 rounded 
          ...
          >
            <div className="flex items-center">
              <img
                ...
                alt={feed.likeCount}
                className="w-5 h-5 rounded-full object-cover p-[1.5px] bg-black"
              />
              <img
                src={feed.mutualFrndImg2}
                alt={feed.likeCount}
                className="w-5 h-5 rounded-full object-cover p-[1.5px] bg-black -ml-3"
              />
            </div>
          ...
          <div className="w-full h-auto flex items-center justify-between border-b border-gray-500">
            <input
              type="text"
              className='w-full h-auto bg-transparent border-none outline-none focus:outline-none text-sm text-gray-400 py-3'
